---
title: "Installing the node from source"
metaTitle: "Installing the node from source"
metaDescription: "Installing the node from source"
---
...
Copy the executables files to the .local/bin directory. Replace the place holder with your targeted version:
